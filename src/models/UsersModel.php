...
class UsersModel {
  ...
  public function addUser($data) {
    ...
    $this->db->query('INSERT INTO users (id, role_id, username, email, password, fullname, phonenumber, address, created_at, updated_at) VALUES (:id, :role_id, :username, :email, :password, :fullname, :phonenumber, :address, :created_at, :updated_at)');
    $this->db->bind('id', $id);
  ...
  public function updateUser($data) {
    ...
    $this->db->query("UPDATE users SET username = :username, fullname = :fullname, email = :email, phonenumber = :phonenumber, address = :address, password = :password, updated_at = :updated_at WHERE id = :id");
    $this->db->bind('username', $data['username']);
    $this->db->bind('fullname', $data['fullname']);
    $this->db->bind('email', $data['email']);
    $this->db->bind('phonenumber', $data['phonenumber']);
  ...
  public function updateUserProfile($data) {
    ...
    $this->db->query('UPDATE users SET username = :username, fullname = :fullname, email = :email, phonenumber = :phonenumber, address = :address, updated_at = :updated_at WHERE id = :id');
    $this->db->bind('username', $data['username']);
    $this->db->bind('fullname', $data['fullname']);
    $this->db->bind('email', $data['email']);
    $this->db->bind('phonenumber', $data['phonenumber']);
